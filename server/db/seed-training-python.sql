...
('e0100000-0000-0000-0000-000000000001', 'Python — Les bases', 'Print, input, variables, types, concaténation. Tes premiers programmes.', 1, 20),
('e0200000-0000-0000-0000-000000000001', 'Python — Logique & Boucles', 'If/else, for, while, opérateurs logiques, compréhensions de liste.', 1, 21),
('e0300000-0000-0000-0000-000000000001', 'Python — Fonctions', 'Paramètres, return, scope, *args, **kwargs, annotations de type.', 1, 22),
('e0400000-0000-0000-0000-000000000001', 'Python — Listes, Tuples, Dicts', 'Structures de données, slices, méthodes, compréhensions avancées.', 2, 23),
('e0500000-0000-0000-0000-000000000001', 'Python — POO', 'Classes, __init__, héritage, méthodes statiques, surcharge, polymorphisme.', 2, 24),
('e0600000-0000-0000-0000-000000000001', 'Python — Fichiers & Erreurs', 'Lecture/écriture fichiers, CSV, Pandas, try/except, logging.', 2, 25),
('e0700000-0000-0000-0000-000000000001', 'Python — APIs & Web', 'Requests, JSON, APIs REST, web scraping, variables d''environnement.', 3, 26),
('e0800000-0000-0000-0000-000000000001', 'Python — Bases de données', 'SQLite, TinyDB, requêtes SQL, CRUD complet.', 3, 27),
('e0900000-0000-0000-0000-000000000001', 'Python — Projets', 'Chiffre de César, Pendu, Quiz, Bot, Scraper. Les boss finaux.', 3, 28);
...
('f0110000-0000-0000-0000-000000000001', 'e0100000-0000-0000-0000-000000000001',
...
('f0120000-0000-0000-0000-000000000001', 'e0100000-0000-0000-0000-000000000001',
 'Types et opérations',
...
('f0130000-0000-0000-0000-000000000001', 'e0100000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0210000-0000-0000-0000-000000000001', 'e0200000-0000-0000-0000-000000000001',
...
('f0220000-0000-0000-0000-000000000001', 'e0200000-0000-0000-0000-000000000001',
...
('f0230000-0000-0000-0000-000000000001', 'e0200000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0310000-0000-0000-0000-000000000001', 'e0300000-0000-0000-0000-000000000001',
...
('f0320000-0000-0000-0000-000000000001', 'e0300000-0000-0000-0000-000000000001',
...
('f0330000-0000-0000-0000-000000000001', 'e0300000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0410000-0000-0000-0000-000000000001', 'e0400000-0000-0000-0000-000000000001',
...
('f0420000-0000-0000-0000-000000000001', 'e0400000-0000-0000-0000-000000000001',
...
('f0430000-0000-0000-0000-000000000001', 'e0400000-0000-0000-0000-000000000001',
...
-- TRACK 5: POO
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0510000-0000-0000-0000-000000000001', 'e0500000-0000-0000-0000-000000000001',
 'Classes et __init__',
...
('f0520000-0000-0000-0000-000000000001', 'e0500000-0000-0000-0000-000000000001',
...
('f0530000-0000-0000-0000-000000000001', 'e0500000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0610000-0000-0000-0000-000000000001', 'e0600000-0000-0000-0000-000000000001',
...
('f0620000-0000-0000-0000-000000000001', 'e0600000-0000-0000-0000-000000000001',
...
('f0630000-0000-0000-0000-000000000001', 'e0600000-0000-0000-0000-000000000001',
...
-- TRACK 7: APIs & Web
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0710000-0000-0000-0000-000000000001', 'e0700000-0000-0000-0000-000000000001',
...
('f0720000-0000-0000-0000-000000000001', 'e0700000-0000-0000-0000-000000000001',
...
('f0730000-0000-0000-0000-000000000001', 'e0700000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0810000-0000-0000-0000-000000000001', 'e0800000-0000-0000-0000-000000000001',
 'SQLite : CRUD complet',
...
('f0820000-0000-0000-0000-000000000001', 'e0800000-0000-0000-0000-000000000001',
...
('f0830000-0000-0000-0000-000000000001', 'e0800000-0000-0000-0000-000000000001',
...
INSERT INTO training_exercises (id, track_id, title, description, instructions, expected_result, level, sort_order, pillar_impact) VALUES
('f0910000-0000-0000-0000-000000000001', 'e0900000-0000-0000-0000-000000000001',
...
('f0920000-0000-0000-0000-000000000001', 'e0900000-0000-0000-0000-000000000001',
...
('f0930000-0000-0000-0000-000000000001', 'e0900000-0000-0000-0000-000000000001',
