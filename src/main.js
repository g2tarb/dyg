...
registerRoute('/messages/:id', (c, p) => renderMessages(c, { id: p.id }));
registerRoute('/messages/project/:projectId', (c, p) => renderMessages(c, { type: 'project', projectId: p.projectId }));
